<script setup>
// Ce fichier va être transferer au dossier views au fichier HomeView.vue
...
<template>
  <WelcomeItem>
    <!--Welcome Item pour dire qu'on recois du fichier WelcomeItem.vue-->
    <template #icon>
      <!--#icon est le nom du slot, template est obligatoire pour utiliser slot si non, cela ne fonctionne pas-->
      <!-- documentationIcon est pour dire qu'on recupère le fichier IconDocumentation
      qui comporte l'icon du livre
       -->
      <DocumentationIcon />
    </template>
